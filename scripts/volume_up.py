...
# 사용자로부터 올릴 볼륨 단계 수 입력 받기
user_input = input("얼마나 볼륨을 올리시겠습니까? (단위: 1씩 증가, 기본값 10): ")
...
for _ in range(steps):
    volume.SetMasterVolumeLevelScalar(min(volume.GetMasterVolumeLevelScalar() + 0.01, 1.0), None)
